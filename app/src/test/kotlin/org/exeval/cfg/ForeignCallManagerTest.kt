...
class ForeignCallManagerTest {
    ...
    fun `test generate_function_call with no arguments and no result`() {
        val function = ForeignFunctionDeclaration("mockFunctionName", listOf(), org.exeval.ast.Int)
    ...
    private fun compareCfgNodes(expected: CFGNode, actualValue: CFGNode): Boolean {
