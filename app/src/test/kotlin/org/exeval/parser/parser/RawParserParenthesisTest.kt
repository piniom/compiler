...
class RawParserParenthesisTest {
    private val actions: Map<Pair<ParSym, Int>, Action<ParSym, Int>> = mapOf(
        ...
        (ParSym.END to 2) to Action.Reduce(grammar.productions[2]),
        (ParSym.END to 4) to Action.Reduce(grammar.productions[1]),
        (ParSym.END to 8) to Action.Reduce(grammar.productions[4]),
        (ParSym.END to 10) to Action.Reduce(grammar.productions[3]),

        (ParSym.OPEN to 0) to Action.Shift(3),
        (ParSym.OPEN to 1) to Action.Shift(3),
        (ParSym.OPEN to 2) to Action.Reduce(grammar.productions[2]),
        (ParSym.OPEN to 3) to Action.Shift(7),
        (ParSym.OPEN to 4) to Action.Reduce(grammar.productions[1]),
        (ParSym.OPEN to 5) to Action.Shift(7),
        (ParSym.OPEN to 6) to Action.Reduce(grammar.productions[2]),
        (ParSym.OPEN to 7) to Action.Shift(7),
        (ParSym.OPEN to 8) to Action.Reduce(grammar.productions[4]),
        (ParSym.OPEN to 9) to Action.Reduce(grammar.productions[1]),
        (ParSym.OPEN to 10) to Action.Reduce(grammar.productions[3]),
        (ParSym.OPEN to 11) to Action.Shift(7),
        (ParSym.OPEN to 12) to Action.Reduce(grammar.productions[4]),
        (ParSym.OPEN to 13) to Action.Reduce(grammar.productions[3]),

        (ParSym.CLOSE to 3) to Action.Shift(8),
        (ParSym.CLOSE to 5) to Action.Shift(10),
        (ParSym.CLOSE to 6) to Action.Reduce(grammar.productions[2]),
        (ParSym.CLOSE to 7) to Action.Shift(12),
        (ParSym.CLOSE to 9) to Action.Reduce(grammar.productions[1]),
        (ParSym.CLOSE to 11) to Action.Shift(13),
        (ParSym.CLOSE to 12) to Action.Reduce(grammar.productions[4]),
        (ParSym.CLOSE to 13) to Action.Reduce(grammar.productions[3]),
    )
