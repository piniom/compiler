...
class InstructionCovererTest {
	...
	fun `cover should return cheapest cover`() {
		...
		val instructionCoverer =
			InstructionCoverer(
				mapOf(
					InstructionPatternMapKey(tree.treeKind(), InstructionKind.EXEC) to
						listOf(
							unaryOpExpensivePattern,
							unaryOpPattern,
						),
					InstructionPatternMapKey(tree.treeKind(), InstructionKind.VALUE) to
						listOf(
							unaryOpExpensivePattern,
							unaryOpPattern,
						),
