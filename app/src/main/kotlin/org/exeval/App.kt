...
fun main(args: Array<String>) {
	...
	val linearizedFunctions =
		nodes.map { it.first to linearizer.createBasicBlocks(it.second) }.map {
	...
	val nasmProcess =
		ProcessBuilder("nasm", "-felf64", "program.asm", "-o", "program.o")
			.inheritIO()
			.start()
	nasmProcess.waitFor()
	...
	val gccProcess =
		ProcessBuilder("gcc", "program.o", "-o", "program")
			.inheritIO()
			.start()
	gccProcess.waitFor()
