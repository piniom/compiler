...
class FunctionAnalyser {
	...
	private fun getFuctionCallToDeclaration(
		call: FunctionCall,
		parentDeclaration: FunctionDeclaration?,
	): FunctionDeclaration? {
		...
		val declarationInChildOfParent =
			functionChilds[parentDeclaration]!!.find { func -> checkIfFuncCallAndDeclarMatch(func, call) }
	...
	private fun checkIfFuncCallAndDeclarMatch(
		declaration: FunctionDeclaration,
		call: FunctionCall,
	): Boolean = call.functionName == declaration.name && call.arguments.size == declaration.parameters.size

	private fun analyseSubtree(
		node: ASTNode?,
	...
	private fun analyseConditional(
	...
	private fun analyseUnaryOperation(
	...
	private fun analyseBinaryOperation(
	...
	private fun analyseFunctionDeclaration(
		declaration: FunctionDeclaration,
		context: FunctionDeclaration?,
	) {
	...
	private fun analyseAnyVariable(
	...
	private fun analyseProgramDeclaration(
		program: Program,
		context: FunctionDeclaration?,
	) {
