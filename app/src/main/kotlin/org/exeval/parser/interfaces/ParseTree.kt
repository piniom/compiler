...
sealed interface ParseTree<S> {
    ...
    data class Branch<S>(val production: Production<S>, val children: List<ParseTree<S>>, override val startLocation: Location, override val endLocation: Location): ParseTree<S>
}