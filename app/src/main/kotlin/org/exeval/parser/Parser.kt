...
class Parser<S>(analyzedGrammar: AnalyzedGrammar<S>) {
    ...
    init {
        ...
        startProduction = analyzedGrammar.grammar.productions.find { production -> production.left == startSymbol} ?: throw IllegalStateException("No production where left=startSymbol")
    }
