...
class CoalescenceGraphCreator {
    ...
    private fun createGraphFromRegisterGraph(graph : RegisterGraph, mapDomainToInt : MutableMap<Register, Int>) : MutableMap<Int, MutableSet<Int>> {
    ...
    private fun checksIfBriggsConditionIsMet(graph : MutableMap<Int, MutableSet<Int>>, uNeighbourhood : Set<Int>,
     vNeighbourhood : Set<Int>, numOfColors : Int) : Boolean {
    ...
    private fun checksIfGeorgeConditionIsMet(graph : MutableMap<Int, MutableSet<Int>>, uNeighbourhood : Set<Int>,
     vNeighbourhood : Set<Int>, numOfColors : Int) : Boolean {
    ...
    private fun mergeToVertex(graph : MutableMap<Int, MutableSet<Int>>, copyGraph : MutableMap<Int, MutableSet<Int>>, v : Int, u : Int) {
        mergeToVertexSingleGraph(graph, v, u)
        mergeToVertexSingleGraph(copyGraph, v, u)
    }

    private fun mergeToVertexSingleGraph(graph : MutableMap<Int, MutableSet<Int>>, v : Int, u : Int) {
        if (!graph.containsKey(u))
            return
