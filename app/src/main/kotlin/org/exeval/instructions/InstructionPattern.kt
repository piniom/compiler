...
data class NumericalConstant(
	val value: Long,
) : ConstantOperandArgumentType

data class DelayedNumericalConstant(
	val getValue: () -> Long,
) : ConstantOperandArgumentType
...
class TemplatePattern(
	...
	private fun split(
		args: List<Tree>,
		constants: MutableList<OperandArgumentType?>,
		toMatch: MutableList<Tree>,
	) {
		constants.clear()
	...
	private fun injectConstants(
		constants: List<OperandArgumentType?>,
		registers: List<VirtualRegister>,
	): List<OperandArgumentType> {
