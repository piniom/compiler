...
class Linearizer(
	private val instructionCoverer: InstructionCovererInterface,
) {
	...
	private fun makeBasicBlocks(
		node: CFGNode,
		result: MutableList<BasicBlock>,
	): BasicBlock {
	...
	private fun generateLabel(): Label = Label("LabelLin" + LabelIdGenerator.getId().toString())

	private class JmpInstruction(
		private val label: Label,
	) : Instruction {
		override fun toAsm(mapping: Map<Register, PhysicalRegister>): String = "jmp " + label.name
