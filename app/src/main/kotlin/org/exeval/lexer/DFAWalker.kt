...
class DFAWalker<S>(
	start: Location,
	private val dfa: DFA<S>,
) : Comparable<DFAWalker<*>> {
	...
	public fun isDead(): Boolean = this.dfa.isDead(this.currentState)

	private fun isAccepting(): Boolean = this.dfa.isAccepting(this.currentState)
	...
	override fun compareTo(other: DFAWalker<*>): Int = this._maxAcceptingCount - other._maxAcceptingCount
}
