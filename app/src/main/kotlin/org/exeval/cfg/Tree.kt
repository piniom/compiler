...
data class LabelConstantTree(
	val label: Label,
) : ConstantTree

data class NumericalConstantTree(
	val value: Long,
) : ConstantTree

data class DelayedNumericalConstantTree(
	val getValue: () -> Long,
) : ConstantTree
...
data class RegisterTree(
	val register: Register,
) : AssignableTree

data class AssignmentTree(
	val destination: AssignableTree,
	val value: Tree,
) : Tree
...
data class BinaryOperationTree(
	val left: Tree,
	val right: Tree,
	val operation: BinaryTreeOperationType,
) : Tree
...
data class UnaryOperationTree(
	val child: Tree,
	val operation: UnaryTreeOperationType,
) : Tree
...
data class StackPushTree(
	val source: Tree,
) : Tree

data class StackPopTree(
	val destination: AssignableTree,
) : Tree
